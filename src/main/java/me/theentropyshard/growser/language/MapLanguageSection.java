...
public class MapLanguageSection implements LanguageSection {
    private static final Logger LOG = LogManager.getLogger(MapLanguageSection.class);
    ...
    public String getString(String key) {
        ...
        if (lastDotIndex == -1) {
            ...
            if (s == null) {
                MapLanguageSection.LOG.warn("Section does not contain string for key: {}", key);
    ...
    public LanguageSection getSection(String key) {
        ...
        if (section == null) {
            MapLanguageSection.LOG.warn("Could not find section by key: {}", key);
